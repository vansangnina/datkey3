...
<?php	
	function get_main_cat()
	{
		...
		$sql_huyen="select * from table_product_cat where id_list=".$id_list." order by stt,id desc ";
	...
	function get_main_list()
	{
		...
		$sql_huyen="select * from table_product_list where id_danhmuc=".$id_danhmuc."  order by stt,id desc ";
		$result=mysql_query($sql_huyen);
		$str='
	...
	function get_main_danhmuc()
	{
		...
		$sql_huyen="select * from table_product_danhmuc where type='".$type."' order by stt,id desc ";
		$result=mysql_query($sql_huyen);
		$str='
